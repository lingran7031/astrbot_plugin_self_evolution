...
class SelfEvolutionPlugin(Star):
    ...
    async def on_llm_request(self, event: AstrMessageEvent, req: ProviderRequest):
        ...
        context_info += (
            "\n【核心认知指令 - 身份隔离原则】：\n"
            "1. 严格区分当前发送者与历史记录中其他群成员的身份。不要将他人的言行（如谩骂、挑衅）误植给当前发送者。\n"
            "2. 上述记录的‘情感积分’仅代表当前发送者的信誉。即使历史记录中存在攻击性内容，只要不是当前发送者发出的，你就必须保持礼貌或中立。\n"
            "3. 在回复时请明确对话对象，若正在回复引用内容，请确保针对该引用内容的发送者进行逻辑闭环回复。"
        )
