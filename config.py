...
class PluginConfig:
    ...
    def moderation_enabled(self):
        return self._get_nested_bool("moderation", "moderation_enabled", True)

    @property
    def moderation_nsfw_enabled(self):
        return self._get_nested_bool("moderation", "moderation_nsfw_enabled", True)

    @property
    def moderation_promo_enabled(self):
        return self._get_nested_bool("moderation", "moderation_promo_enabled", True)

    @property
    def moderation_auto_punish_enabled(self):
        return self._get_nested_bool("moderation", "moderation_auto_punish_enabled", True)

    @property
    def moderation_nsfw_delete_confidence(self):
        return float(self._get_nested("moderation", "moderation_nsfw_delete_confidence", 0.85))

    @property
    def moderation_promo_delete_confidence(self):
        return float(self._get_nested("moderation", "moderation_promo_delete_confidence", 0.85))

    @property
    def moderation_warn_threshold(self):
        return int(self._get_nested("moderation", "moderation_warn_threshold", 1))

    @property
    def moderation_ban_threshold(self):
        return int(self._get_nested("moderation", "moderation_ban_threshold", 2))

    @property
    def moderation_kick_threshold(self):
        return int(self._get_nested("moderation", "moderation_kick_threshold", 3))

    @property
    def moderation_promo_warn_threshold(self):
        return int(self._get_nested("moderation", "moderation_promo_warn_threshold", 1))

    @property
    def moderation_promo_ban_threshold(self):
        return int(self._get_nested("moderation", "moderation_promo_ban_threshold", 2))

    @property
    def moderation_promo_kick_threshold(self):
        return int(self._get_nested("moderation", "moderation_promo_kick_threshold", 3))

    @property
    def moderation_whitelist_users(self):
        return self._get_nested_list("moderation", "moderation_whitelist_users", [])

    @property
    def moderation_whitelist_groups(self):
        return self._get_nested_list("moderation", "moderation_whitelist_groups", [])

    @property
    def moderation_prefer_caption_reuse(self):
        return self._get_nested_bool("moderation", "moderation_prefer_caption_reuse", True)
